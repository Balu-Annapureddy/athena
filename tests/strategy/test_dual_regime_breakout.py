"""Unit tests for DualRegimeBreakoutVolumeATRStrategy."""
...
class TestDualRegimeBreakoutVolumeATRStrategy(unittest.TestCase):
    """Test suite for DualRegimeBreakoutVolumeATRStrategy."""

    def setUp(self) -> None:
        self.strategy = DualRegimeBreakoutVolumeATRStrategy(
            breakout_period=20,
            vol_threshold=15.0,
    ...
    def test_strategy_metadata(self) -> None:
        self.assertEqual(self.strategy.name, "DualRegimeBreakoutVolumeATRStrategy")
