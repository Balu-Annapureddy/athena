"""Unit tests for BreakoutVolumeATRTrailingHybridStrategy."""
...
class TestBreakoutVolumeATRTrailingHybridStrategy(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.strategy = BreakoutVolumeATRTrailingHybridStrategy(
            breakout_period=5,
            volume_trend_threshold=10.0,
    ...
    def test_strategy_metadata(self) -> None:
        self.assertEqual(self.strategy.name, "BreakoutVolumeATRTrailingHybridStrategy")
