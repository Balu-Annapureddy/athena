"""Single Locked OOS Evaluation for Attempt 4 (DonchianTrendATRStrategy).
...
Evaluates:
- Gate 1: NIFTY 50 (2021-2026)
- Gate 2: NIFTY 100 (2021-2026) if Gate 1 passes
"""
...
def main():
    print("================================================================================", flush=True)
    print("ATHENA STRATEGY ATTEMPT 4: LOCKED OUT-OF-SAMPLE EVALUATION (2021-2026)", flush=True)
    print("Strategy: DonchianTrendATRStrategy", flush=True)
    print("Parameters: donchian=50d, atr=4.0x, adx=22, vol=10%, r=2.0%, pos=10", flush=True)
    print("================================================================================", flush=True)
    ...
    if not gate1_passed:
        ...
        print("Classified as UNVALIDATED.")
        return
